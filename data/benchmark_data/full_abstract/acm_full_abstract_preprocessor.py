...
x_filename = '..\\..\\preprocessed_data\\full_abstract\\x_ACM_FULL_ABSTRACT_TEST_vectors'
y_filename = '..\\..\\preprocessed_data\\full_abstract\\y_ACM_FULL_ABSTRACT_TEST_vectors'


# Define the file paths and names to save preprocessed TEXT of ABSTRACT and KEYPHRASES
x_text_filename = '..\\..\\preprocessed_data\\full_abstract\\x_ACM_FULL_ABSTRACT_preprocessed_TEXT'  # save preprocessed text for TEST data
y_text_filename = '..\\..\\preprocessed_data\\full_abstract\\y_ACM_FULL_ABSTRACT_preprocessed_TEXT'  # save preprocessed keyphrases for TEST data
...
# Max length of title and abstract (492)
# max_len = max(data['abstract'].apply(len))  # Max length of title and abstract
...
# ======================================================================================================================
# Write pre-processed TRAIN data to hdf file
# ======================================================================================================================
