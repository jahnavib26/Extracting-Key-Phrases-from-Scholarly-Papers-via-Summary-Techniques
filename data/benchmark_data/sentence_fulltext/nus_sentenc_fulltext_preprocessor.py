...
file = '..\\NUS.json'  # TEST data to evaluate the final model


# Define the file paths and names to save TEST data to evaluate the final model
x_filename = '..\\..\\preprocessed_data\\sentence_fulltext\\x_NUS_SENTEC_FULLTEXT_TEST_data_preprocessed'
y_filename = '..\\..\\preprocessed_data\\sentence_fulltext\\y_NUS_SENTEC_FULLTEXT_TEST_data_preprocessed'


# Define the file paths and names to save preprocessed TEXT of ABSTRACT and KEYPHRASES
x_text_filename = '..\\..\\preprocessed_data\\sentence_fulltext\\x_NUS_SENTEC_FULLTEXT_preprocessed_TEXT'  # save preprocessed text for TEST data
y_text_filename = '..\\..\\preprocessed_data\\sentence_fulltext\\y_NUS_SENTEC_FULLTEXT_preprocessed_TEXT'  # save preprocessed keyphrases for TEST data
...
for index, abstract in enumerate(data['abstract']):
    ...
    print('title_abstract_mainBody', title_abstract_mainBody)
...
#data = data[data['abstract'].str.contains(' ')]  # remove single words
# reset index as explode results in multiple rows having the same index
data.reset_index(drop=True, inplace=True)
...
# ======================================================================================================================
# Give labels to each word of Title, Abstract and Fulltext - keyword (KP) or Non-keyword (Non-KP)
# ======================================================================================================================
...
'''
KP count:  38382 
KP WORDS count:  55360 
NON-KP count:  1372383
X SHAPE (74219, 729)
'''
...
# Max length of title, abstract and fulltext (927)
